...
description: vlcnpStory6 の機能追加・不具合修正で、既存実装の再利用と変更に応じた検証範囲を判断する。
---
...
- Unity を操作するときは [Editor 操作](../unity-editor-automation/SKILL.md) を使う。まとまった C# 変更を インポートして再コンパイル し、その後に編集がなければ同じ検証を繰り返さない。
