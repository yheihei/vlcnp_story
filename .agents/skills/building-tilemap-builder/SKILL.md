...
description: vlcnpStory6 の建物・室内タイルセットを作成する、または壁の継ぎ目・建具素材を修正するときに使う。
---
...
変更した画像は寸法と接続・重ね合わせを目視確認する。Unity へ組み込む場合は Import と対象参照・コライダー・保存を確認する。C# を変えていなければ 再コンパイルは不要。
