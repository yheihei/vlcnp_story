...
| `config` (proxy / update-check / accelerator / get / set / list / unset), `context` (save / use / list / current / delete), `hub install` | [config-hub.md](references/config-hub.md) |
| `run`, `test`, `build`, `watch` (`test`) | [build-run-test.md](references/build-run-test.md) |
