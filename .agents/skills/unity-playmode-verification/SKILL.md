...
- [Editor 操作](../unity-editor-automation/SKILL.md) に従い、対象プロジェクトと接続を確認する。公式Unity CLIの `editor_play` / `editor_stop`、`find_gameobjects`、`get_component_properties`、`console`、`capture_game_view` を使う。引数は現在の `unity command` の定義で確認する。
